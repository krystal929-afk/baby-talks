  ...
  head: () => ({
    meta: [
      { title: "Baby's Calendar — Mr. Satan" },
      {
        name: "description",
        content:
          "Daddy's gigs, appointments, and reminders Baby tucked away.",
      },
    ],
  }),
  component: () => (
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          notes:
            "Just makin' sure I can buzz ya, daddy.",
        });

      if (error) throw error;

      toast.success(
        "Test ping armed — Baby'll buzz in ~90 seconds.",
      );
    ...
    <div className="min-h-screen pb-24">
      <header className="relative px-4 pb-4 pt-8 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Gigs, dates, anything Baby tucked into the
          schedule.
        </p>
      </header>
      ...
      <main className="mx-auto max-w-3xl px-4">
        ...
        {isLoading ? (
          ...
          <div className="rounded-2xl border border-border/60 bg-card/40 p-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Tell Baby in chat — &quot;I have
              a gig Friday at 8&quot; — or tap
              Add event.
            </p>
          </div>
        ) : (
...
function AddEventDialog({
  ...
  async function save() {
    ...
    try {
      ...
      toast.success(
        "Tucked it on your calendar, Mr. S.",
      );
